...
class IAMClient {
    ...
    fun printClient() {
        ...
        println("Ali, serai-shipment: ${Base64.getEncoder().encodeToString("serai-shipment:pSk61gkY2X9FdsFHLa8n7QZg2db4HIlp".toByteArray(Charsets.UTF_8))}")
        ...
        println("Ali wateredge-api: ${Base64.getEncoder().encodeToString("wateredge-api:CdM2LxEEThtEyMBZxitbgKEAsurasUbZ".toByteArray(Charsets.UTF_8))}")
        println("Ali wateredge-web: ${Base64.getEncoder().encodeToString("wateredge-web:dDU6R1FZ17RBkO5Pe65oHBB3LShBwQWA".toByteArray(Charsets.UTF_8))}")
        println("Ali platform-profile: ${Base64.getEncoder().encodeToString("platform-profile:syc6sN3cOYahZZZbOI78shA0G4vzgG7Q".toByteArray(Charsets.UTF_8))}")
